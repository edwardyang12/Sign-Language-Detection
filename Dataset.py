...
'''
def Dataset(Img_dir = r'C:\Users\Edward\Desktop\VOC2012\VOC2012\JPEGImages', ann_dir = r'C:\Users\Edward\Desktop\VOC2012\VOC2012\Annotations'):
    ...
    for xml_file in os.listdir(ann_dir):
        try :
            ...
            for sroot in root:
                ...
                if sroot.tag == 'size':
                    if(int(sroot[0].text)==3):
                        width = float(sroot[2].text)
